...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  neteaseCloudPlaylistSaveRef: (payload) => ipcRenderer.invoke('netease:cloud-playlist:save-ref', payload),
  neteaseCloudPlaylistRemoveRef: (payload) => ipcRenderer.invoke('netease:cloud-playlist:remove-ref', payload),
