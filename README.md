...
10. 单曲、歌单的查询，要尽可能展示完整的信息，如歌曲名称、歌手、专辑、封面等，方便用户确认下载内容。当前缺封面 ，其他细节也可以补充完善。
11. 歌单管理，就像下载管理一样，也从歌曲页面剥离出来，单独做一个歌单管理页面，
12. 歌单下载，当前似乎只会下载歌单中的10首歌，需要排查原因，确保能够完整下载歌单中的所有歌曲。